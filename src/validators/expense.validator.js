...
const addExpenseValidation = [
    ...
    body("category").notEmpty().withMessage("Category is required").isIn(["Food & Dining", "Beauty", "Transportation", "Housing", "Shopping", "Education", "Entertainment", "Travel", "Family", "Financial", "Work", "Personal", "Charity", "Health", "Other"]).withMessage("Invalid category"),
